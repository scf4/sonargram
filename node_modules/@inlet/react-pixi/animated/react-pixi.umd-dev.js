(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('pixi.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'pixi.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactPixi = {}, global.React, global.PIXI));
}(this, (function (exports, React, pixi_js) { 'use strict';
	...
	***************************************************************************** */
	...
	var FrameLoop_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	// The global `requestAnimationFrame` must be dereferenced to avoid "Illegal invocation" errors
	var requestAnimationFrame = function (fn) {
	    return (0, globals.requestAnimationFrame)(fn);
	};
	/**
	    ...
	    function FrameLoop(raf) {
	        ...
	        var advance = (this.advance = function () {
	            ...
	            if (timeoutQueue.length) {
	                globals.batchedUpdates(function () {
	            ...
	            if (time > lastTime) {
	                ...
	                globals.batchedUpdates(function () {
	                    ...
	                    if (animations.length) {
	                        globals.willAdvance(animations);
	...
	unwrapExports(FrameLoop_1);
	FrameLoop_1.FrameLoop;
	...
	exports.isAnimatedString = function (value) {
	    return exports.is.str(value) &&
	        (value[0] == '#' ||
	            /\d/.test(value) ||
	            !!(globals.colorNames && globals.colorNames[value]));
	};
	...
	helpers.noop;
	helpers.defineHidden;
	helpers.is;
	helpers.isEqual;
	helpers.isAnimatedString;
	helpers.each;
	helpers.toArray;
	helpers.flush;
	...
	exports.batchedUpdates = function (callback) { return callback(); };
	exports.willAdvance = helpers.noop;
	exports.assign = function (globals) {
	    ...
	    }, pluckDefined(globals)), exports.to = _a.to, exports.now = _a.now, exports.frameLoop = _a.frameLoop, exports.colorNames = _a.colorNames, exports.skipAnimation = _a.skipAnimation, exports.createStringInterpolator = _a.createStringInterpolator, exports.requestAnimationFrame = _a.requestAnimationFrame, exports.batchedUpdates = _a.batchedUpdates, exports.willAdvance = _a.willAdvance, _a);
	};
	...
	var require$$0 = getCjsExportFromNamespace(types);

	var types_util = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	tslib.__exportStar(require$$0, exports);

	});

	unwrapExports(types_util);

	var hooks = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	exports.useOnce = function (effect) { return React__default['default'].useEffect(effect, []); };
	/** Return a function that re-renders this component, if still mounted */
	exports.useForceUpdate = function () {
	    var update = React__default['default'].useState(0)[1];
	    var unmounted = React__default['default'].useRef(false);
	...
	function usePrev(value) {
	    var prevRef = React__default['default'].useRef(undefined);
	...
	var createInterpolator = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });


	exports.createInterpolator = function (range, output, extrapolate) {
	    if (helpers.is.fun(range)) {
	        return range;
	    }
	    if (helpers.is.arr(range)) {
	    ...
	    if (helpers.is.str(range.output[0])) {
	        return globals.createStringInterpolator(range);
	    }
	    var config = range;
	...
	unwrapExports(createInterpolator);
	...
	cjs$1.hasFluidValue;
	cjs$1.getFluidValue;
	cjs$1.getFluidConfig;
	cjs$1.setFluidConfig;
	cjs$1.addFluidObserver;
	cjs$1.FluidValue;
	...
	tslib.__exportStar(types_util, exports);
	tslib.__exportStar(hooks, exports);
	tslib.__exportStar(helpers, exports);
	tslib.__exportStar(FrameLoop_1, exports);
	tslib.__exportStar(createInterpolator, exports);
	tslib.__exportStar(cjs$1, exports);
	...
	var setAnimated = function setAnimated(owner, node) {
	  return cjs.defineHidden(owner, $node, node);
	};
	...
	var AnimatedString = /*#__PURE__*/function (_AnimatedValue) {
	  ...
	  function AnimatedString(from, to) {
	    ...
	    _this._toString = cjs.createInterpolator({
	      output: [from, to]
	    });
	    return _this;
	  }
	  ...
	  AnimatedString.create = function create(from, to) {
	    ...
	    if (cjs.is.str(from) && cjs.is.str(to)) {
	  ...
	  _proto.reset = function reset(goal) {
	    if (goal) {
	      this._toString = cjs.createInterpolator({
	...
	var AnimatedObject = /*#__PURE__*/function (_Animated) {
	  ...
	  _proto.getValue = function getValue(animated) {
	    ...
	    var values = {};
	    cjs.each(this.source, function (source, key) {
	      if (isAnimated(source)) {
	        values[key] = source.getValue(animated);
	      } else {
	        var config = cjs.getFluidConfig(source);
	  ...
	  _proto.reset = function reset() {
	    if (this.payload) {
	      cjs.each(this.payload, function (node) {
	        return node.reset();
	      });
	    }
	  }
	  ...
	  _proto._makePayload = function _makePayload(source) {
	    if (source) {
	      var payload = new Set();
	      cjs.each(source, this._addToPayload, payload);
	  ...
	  _proto._addToPayload = function _addToPayload(source) {
	    ...
	    if (payload) {
	      cjs.each(payload, function (node) {
	...
	var AnimatedArray = /*#__PURE__*/function (_AnimatedObject) {
	  ...
	  _proto.setValue = function setValue(newValue) {
	    ...
	    if (newValue && newValue.length == payload.length) {
	      cjs.each(payload, function (node, i) {
	  ...
	  _proto._makeAnimated = function _makeAnimated(from, to) {
	    ...
	    return from ? from.map(function (from, i) {
	      return (cjs.isAnimatedString(from) ? AnimatedString : AnimatedValue).create(from, to[i]);
	    }) : [];
	  };
	...
	var withAnimated = function withAnimated(Component, host) {
	  return React__default['default'].forwardRef(function (rawProps, ref) {
	    var instanceRef = React__default['default'].useRef(null);
	    var hasInstance = // Function components must use "forwardRef" to avoid being
	    // re-rendered on every animation frame.
	    !cjs.is.fun(Component) || Component.prototype && Component.prototype.isReactComponent;
	    var forceUpdate = cjs.useForceUpdate();
	    ...
	    useLayoutEffect.useLayoutEffect(function () {
	      cjs.each(dependencies, function (dep) {
	        return dep.addChild(props);
	      });
	      return function () {
	        return cjs.each(dependencies, function (dep) {
	          return dep.removeChild(props);
	        });
	      };
	    });
	    return /*#__PURE__*/React__default['default'].createElement(Component, _extends({}, host.getComponentProps(props.getValue()), {
	...
	function updateRef(ref, value) {
	  if (ref) {
	    if (cjs.is.fun(ref)) ref(value);else ref.current = value;
	  }
	...
	var createHost = function createHost(components, _temp) {
	  ...
	  cjs.each(components, function (Component, key) {
	    if (!cjs.is.str(key)) {
	...
	var getDisplayName = function getDisplayName(arg) {
	  return cjs.is.str(arg) ? arg : arg && cjs.is.str(arg.displayName) ? arg.displayName : cjs.is.fun(arg) && arg.name || null;
	};
	...
	index_cjs.Animated;
	index_cjs.AnimatedArray;
	index_cjs.AnimatedObject;
	index_cjs.AnimatedProps;
	index_cjs.AnimatedString;
	index_cjs.AnimatedValue;
	var index_cjs_7 = index_cjs.createHost;
	index_cjs.getAnimated;
	index_cjs.getPayload;
	index_cjs.isAnimated;
	index_cjs.setAnimated;
	...
	var host = index_cjs_7(primitives, {
